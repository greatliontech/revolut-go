...
func TestCustomers_Create_EmitsVersionHeader(t *testing.T) {
	...
	_, err := client.Customers.Create(context.Background(), "Bearer sk", CustomersRevolutAPIVersion20251204, CustomerCreationV2{
...
func TestCustomers_Get_UUIDValidation(t *testing.T) {
	...
	_, err := client.Customers.Get(context.Background(), "typo", "Bearer sk", CustomersRevolutAPIVersion20251204)
...
func TestCustomers_List_QueryParamsEncoding(t *testing.T) {
	...
	_, err := client.Customers.GetList(context.Background(), "Bearer sk", CustomersRevolutAPIVersion20251204, &RetrieveCustomerListParams{
		Limit: 25,
	})
	if err != nil {
...
func TestOrders_GetList_EmptyResponseDecodes(t *testing.T) {
	...
	resp, err := client.Orders.GetList(context.Background(), "Bearer sk", OrdersRevolutAPIVersion20251204, nil)
	if err != nil {
		t.Fatalf("GetList: %v", err)
	}
	if resp.Orders == nil {
...
func TestWebhooks_Delete_204(t *testing.T) {
	...
	err := client.Webhooks.Delete(context.Background(), "11111111-1111-1111-1111-111111111111", "Bearer sk", WebhooksRevolutAPIVersion20251204)
	if err != nil {
